...
import { apiRequest, fetchPosts, getUserInfo, handleFileUpload, likePost, sendFriendRequest } from '../utils/index.js';
        ...
        <div className="w-full px-0 lg:px-10 pb-5 md:pb-20 2xl:px-40 bg-bgColor lg:rounded-lg h-screen overflow-hidden">
            ...
            <div className="w-full flex gap-2 lg:gap-4 pt-5 pb-10 h-full">
                ...
                <div className="flex-1 h-full bg-orimary px-4 flex flex-col gap-6 overflow-y-auto">
                    <form onSubmit={handleSubmit(onSubmitPost)} className="bg-primary px-4 rounded-lg">
                ...
                <div className="hidden w-1/4 h-full lg:flex flex-col gap-8 overflow-y-auto">
                        ...
                        <div className="w-full flex flex-col gap-4 pt-4">
                            {friendRequest?.map(({ _id, requestFrom: from }, index) => (
                                <div className="flex items-center justify-between" key={index + _id}>
                                    <Link to={`/profile/`+from._id} key={from?._id}
                                    ...
                                    <div className="flex gap-1">
                                        <CustomButton title="Accept" onClick={() => acceptFriendRequest(_id, "Accepted")}
                    ...
                    {/* Suggested Friends */}
                    <div className="w-full bg-primary shadow-lg rounded-lg px-6 py-5">
                        <div className="flex items-center justify-between text-xl text-ascent-1 pb-2 border-b border-[#66666645]">
                        ...
                        <div className="w-full flex flex-col gap-4 pt-4">
                            {suggestedFriends?.map((friend, index) => (
                                <div className="flex items-center justify-between" key={index + friend?._id}>
                                    ...
                                    <div className="flex gap-1">
                                        <button className="bg-[#0444a430] text-sm p-3 rounded text-black">
                                            {(sentFriendRequest.findIndex((request) => request.requestTo._id === friend._id) === -1) ? (
